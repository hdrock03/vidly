...
route.post('/', async (req, res) => {
    ...
    res.send(_.pick(user, ['_id','name', 'email'])) // we are using pick method 1 argument is which object we need to operate and then 2nd which property we need to take
})
